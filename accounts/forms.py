...
class CustomUserCreationForm(UserCreationForm):
    ...
    class Meta:
        model = User
        fields = ['username', 'first_name', 'last_name', 'email', 'account_type', 'password1', 'password2', 'gender', 'birth_date', 'street_address', 'postal_code', 'city', 'country']
    ...
    def save(self, commit=True):
        ...
        if commit:
            ...
            UserBankAccount.objects.create(
                ...
                account_number = 1002024+user.id,
